...
proponent_id = "A94309" #Used to be proponentName
...
class MapInfo:
    def __init__ (self, map_name, map_frame, layout, permit_string, dir_path):
        ...
        self.layout = layout
        self.permit_string = permit_string
        self.dir_path = dir_path
        self.permit_dir = os.path.join(dir_path, permit_string)
    ...
    def update_layer_connection(self, layer_name):
        ...
        target_lyr = layers[0]
        new_shapefile_path = os.path.join(self.permit_dir, f"{self.permit_string}_FN.shp")
        new_conn_props = {
