...
def setup_logging():
    ...
    log_folder = f'auto_batch_logs_{datetime.datetime.now().strftime("%Y%m%d")}'
    ...
    log_file = os.path.join(log_folder, f'batch_log_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
